...
cc.Class({
    ...
    onLoad () {
        ...
        for(var i = 0; i < 3 ; i++){
            var index = i+1;
            self._rankShowWidget[i] = cc.find("rank_"+index,self.node);
            console.log("self._rankShowWidget",self._rankShowWidget[i])
        }
        self.register()
    },
    register(){
    ...
    initBestsData()
    {
        ...
        for(let i = 0; i < 3 ; i++){
            ...
            console.log("initBestsData:",value,value2)
    ...
    _initBestsView(list){
        for(let i = 0; i < 3 ; i++){
            ...
            console.log("self._rankShowWidget",list[i],self._rankShowWidget[i])
        }      
    },
